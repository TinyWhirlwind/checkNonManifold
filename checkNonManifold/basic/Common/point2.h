...
//////////////////////////  数学操作  //////////////////////////////
	...
	{return AXYMath::Atan2(_v[1],_v[0]);}
	...
	{
	  ScalarType l = _v[0];
	  _v[0] = (ScalarType)(l* AXYMath::Cos(_v[1]));
	  _v[1] = (ScalarType)(l* AXYMath::Sin(_v[1]));
	  return *this;
	}
	...
	{
	  ScalarType t = _v[0];
	  ScalarType s = AXYMath::Sin(rad);
	  ScalarType c = AXYMath::Cos(rad);
	  _v[0] = _v[0]*c - _v[1]*s;
	  _v[1] =   t *s + _v[1]*c;
	  return *this;
	}
