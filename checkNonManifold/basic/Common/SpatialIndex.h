#ifndef _SPATIALINDEX_
#define _SPATIALINDEX_
...
Description:
	...
	structures, i.e. uniform grids, bounding volume trees.
...
public:
	...
	**************************************************************************/
    ...
    bool Empty() // check if the spatial structure is empty. 
    {
     return true;
    }
