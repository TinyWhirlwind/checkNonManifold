...
namespace sn3DCore
{
	...
	void CoordinateSystem::Cylinder(int slices, float lenght, float width)
	{
	...
	void CoordinateSystem::Cone(int slices, float lenght, float width)
	{
		Point3f p0;//顶点或中心点
		Point3f P[2];
		Point3f N[2];
	...
	void CoordinateSystem::Arrow(float body_lengtht, float body_width, float head_lenght, float head_width, int body_slice, int head_slice)
	{
	...
	void CoordinateSystem::MoveArrow(float scale, int body_slice, int head_slice)
	{
	...
	void CoordinateSystem::RotateArrow(float scale, int body_slice, int head_slice)
	{
	...
	void CoordinateSystem::DrawCoordinateSystem()
	{
		...
		colorv[0] = 0.6; colorv[1] = 0.0; colorv[2] = 0.0;
		colord[0] = 0.6; colord[1] = 0.0; colord[2] = 0.0;
		colors[0] = 0.6; colors[1] = 0.0; colors[2] = 0.0;
		...
		colorv[0] = 0.0; colorv[1] = 0.6; colorv[2] = 0.0;
		colord[0] = 0.0; colord[1] = 0.6; colord[2] = 0.0;
		colors[0] = 0.0; colors[1] = 0.6; colors[2] = 0.0;
		...
		colorv[0] = 0.0; colorv[1] = 0.0; colorv[2] = 0.6;
		colord[0] = 0.0; colord[1] = 0.0; colord[2] = 0.6;
		colors[0] = 0.0; colors[1] = 0.0; colors[2] = 0.6;
