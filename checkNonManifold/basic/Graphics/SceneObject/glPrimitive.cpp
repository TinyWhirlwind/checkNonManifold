...
namespace sn3DCore
{
    void glPrimitive::Cylinder(int slices,float lenght,float width)
    {
        Point3f p0;
        Point3f p1;
    ...
    void glPrimitive::Cone(int slices,float lenght,float width)
    {
        Point3f p0;//顶点或中心点
        Point3f P[2];
        Point3f N[2];
    ...
    void glPrimitive::Arrow(float body_lengtht,float body_width,float head_lenght,float head_width,int body_slice,int head_slice)
    {
    ...
    void glPrimitive::MoveArrow(float scale,int body_slice,int head_slice)
    {
        Point3f p0;
        Point3f p1;
        Point3f P[2];
    ...
    void glPrimitive::RotateArrow(float scale,int body_slice,int head_slice)
    {
