...
namespace sn3DCore
{
	...
	void SceneObject::Arrow(float body_lengtht,float body_width,float head_lenght,float head_width,int body_slice,int head_slice)
	{
	...
	void SceneObject::MoveArrow(float scale,int body_slice,int head_slice)
	{
	...
	void SceneObject::RotateArrow(float scale,int body_slice,int head_slice)
	{
	...
	void SceneObject::DrawCoordinateSystem()
	{
